...
<html>
	...
	<header>
		...
		<div class="content">
			...
			<div class="buttonss">
			<button class="tablinks" style="width: 50%" onclick="document.location='profile.php'">Personal Details</button>
            <button class="tablinks-active" style="width: 50%"  onclick="document.location='editdetails.php'">Edit Details</button>
			</div>
			...
			<hr style="border-color: rgb(168, 168, 168); width:50%; margin:0 auto; opacity: 20%; margin-top:60px; margin-bottom:15px">
				...
				<table style="text-align: left;">
                    ...
                    <tr>
                        <td colspan="2" style="color:grey; font-weight:lighter; font-size:14px; text-align:center;">E-mail cannot be changed</td>
                    </tr>
					<tr>
