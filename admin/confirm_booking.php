...
form#confirmForm input[type="email"],
    ...
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li style="margin-left: 0px;"><a href="list_cancelrequest.php">Cancellation Requests</a></li>
...
<div class="container">
    ...
    <form method="POST" action="complete_booking.php" id="confirmForm" style="padding-bottom: 5px; border-bottom-left-radius:0px; border-bottom-right-radius: 0px;">
                ...
                <input type="text" id="total_fare" name="total_fare" value="<?= $total_fare_numbers[0]; ?>" readonly>
                    ...
                    <input type="hidden" name="ticket_no" value="<?= $ticketNumber; ?>">
            ...
            if (isset($_SESSION['validate_msg'])) {
                echo "<li style='list-style: none; color:red; text-align:center;'>".$_SESSION['validate_msg']."</li>"; // Display the alert message
                unset($_SESSION['validate_msg']); // Clear the session message after displaying
            }
            ?>

<br>
                    <button type="submit" name="confirm" id="confirmButton">Confirm Booking</button>
...
function cancelBookingRefresh() {
    ...
    xhr.send();
            ...
            const paymentFormIds = ["khaltiform", "esewaform", "cancelForm", "confirmForm"]; // Add more form IDs as needed
